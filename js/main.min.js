...
/* harmony import */ var _modules_no_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/no-js */ "./js/modules/no-js.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_no_js__WEBPACK_IMPORTED_MODULE_4__["initNoJs"])();
    Object(_modules_menu__WEBPACK_IMPORTED_MODULE_2__["initMenu"])();
    Object(_modules_cards__WEBPACK_IMPORTED_MODULE_3__["initCards"])();
    var form = new _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_1__["Form"]();
    window.form = form;
    form.init();
    Object(_modules_map__WEBPACK_IMPORTED_MODULE_5__["initMap"])();
  });
});
  ...
  if (cards.length) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        var cardBg = card.querySelector('.card__background');
        if (caption && cardBg) {
          var cardBgTitle = document.createElement('span');
...
var LOCATION = [59.938631, 30.323037];
function init() {
...
var burgerContainer = document.querySelector('[data-burger-container]');
...
var initNoJs = function initNoJs() {
  if (noJsElements.length) {
    var _iterator = _createForOfIteratorHelper(noJsElements),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
